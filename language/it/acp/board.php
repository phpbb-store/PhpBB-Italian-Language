...
$lang = array_merge($lang, array(
	...
	'SMTP_ALLOW_SELF_SIGNED'		=> 'Consenti certificati SSL auto-firmati',
	'SMTP_ALLOW_SELF_SIGNED_EXPLAIN'=> 'Consentire le connessioni al server SMTP con certificato SSL autofirmato.<em><strong>Attenzione:</strong> Consentire certificati SSL auto-firmati potrebbe causare problemi sulla sicurezza.</em>',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Tieni presente che è necessario fornire il protocollo che il server utilizza. Se si utilizza il protocollo SSL, questo deve essere "ssl://your.mailserver.com"',
	...
	'SMTP_VERIFY_PEER'				=> 'Verifica del certificato SSL',
	'SMTP_VERIFY_PEER_EXPLAIN'		=> 'Richiedi la verifica del certificato SSL utilizzato dal server SMTP.<em><strong>Attenzione:</strong> il collegamento di peer con certificati SSL non verificati può causare problemi di sicurezza.</em>',
	...
	'SMTP_VERIFY_PEER_NAME'			=> 'Verifica il nome peer SMTP',
	'SMTP_VERIFY_PEER_NAME_EXPLAIN'	=> 'Richiedi la verifica del nome peer per i server SMTP utilizzando connessioni SSL / TLS.<em><strong>Attenzione:</strong> la connessione a peer non verificati può causare problemi di sicurezza.</em>',
	'TEST_EMAIL_SENT'				=> 'L’email di prova è stata inviata.<br />Se non la dovessi ricevere, controlla le tue configurazioni di posta elettronica e la cartella antispam del tuo account di posta<br /><br />Se hai bisogno di supporto, visita il <a href="https://www.phpbbitalia.net/forum/">forum di supporto di phpBB Italia</a>.',
