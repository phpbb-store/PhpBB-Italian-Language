...
$lang = array_merge($lang, array(
	...
	'SUPPORT_BODY'		=> 'Supporto completo viene fornito per la versione più recente di phpBB3 su phpBB.com (in Inglese) e su phpBBItalia.net (in Italiano). Questo include problemi relativi a:</p><ul><li>installazione</li><li>configurazione</li><li>questioni tecniche</li><li>possibili bug nel software</li><li>aggiornamento da Release Candidate (RC) all’ultima versione stabile</li><li>conversione da phpBB 2.0.x a phpBB3</li><li>conversione da altri software per forum a phpBB3 (vedere in particolare i <a href="https://www.phpbb.com/community/viewforum.php?f=486">Convertitori per Forum</a>, in inglese)</li></ul><p>Invitiamo gli utenti che utilizzano ancora versioni beta di phpBB3 a sostituire la loro installazione con una nuova copia della versione più recente.</p><h2>Estensioni / Stili</h2><p>Per questioni relative alle Estensioni, consultate gli appropriati forum su <a href="https://www.phpbbitalia.net/forum/viewforum.php?f=207">phpBBItalia.net</a> o <a href="https://www.phpbb.com/community/viewforum.php?f=451">phpBB.com</a>.<br />Analogamente per gli stili, template e temi, consultate i relativi forum su <a href="https://www.phpbbitalia.net/forum/viewforum.php?f=209">phpBBItalia.net</a> o <a href="https://www.phpbb.com/community/viewforum.php?f=471">phpBB.com</a>.<br /><br />Se le domande riguardano una specifica estensione o uno specifico stile, scrivi direttamente nell’argomento dedicato a quella estensione o a quello stile su phpBB.com o phpBBItalia.net.</p><h2>Come ottenere supporto su phpBBItalia.net</h2><p><a href="https://www.phpbbitalia.net/forum/viewforum.php?f=36">Guide e FAQ su phpBB3</a><br /><a href="https://www.phpbbitalia.net/forum/viewforum.php?f=205">Forum con informazioni e supporto</a>.</p><h2>Come ottenere supporto su phpBB.com (in Inglese)</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">Risorse e riferimenti</a><br /><a href="https://www.phpbb.com/support/">Sezione di supporto</a><br /><a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/">Quick Start Guide</a><br /><br />Per assicurarti di essere aggiornato sulle ultime novità e release, puoi sottoscrivere la <a href="https://www.phpbb.com/support/">mailing list di phpBB.com</a>.<br /><br />',
...
$lang = array_merge($lang, array(
	...
	'TIMEOUT_DETECTED_MESSAGE'	=> 'Il programma di installazione ha rilevato un timeout; si può tentare di aggiornare la pagina che può portare alla corruzione dei dati. Ti suggeriamo di aumentare le impostazioni di timeout oppure prova ad utilizzare il CLI (Command Linee Interface), [Interfaccia Linea di Comando].',
));
